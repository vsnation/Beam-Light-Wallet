...
BEAM_VERSION="7.5.13882"
BINARIES_DIR="$RESOURCES_DIR/binaries/macos"
WALLETS_DIR="$RESOURCES_DIR/wallets"
LOGS_DIR="$RESOURCES_DIR/logs"

# Create directories
mkdir -p "$BINARIES_DIR" "$WALLETS_DIR" "$LOGS_DIR"
...
mkdir -p "$APP_BUNDLE/Contents/Resources/binaries/macos"
mkdir -p "$APP_BUNDLE/Contents/Resources/wallets"
mkdir -p "$APP_BUNDLE/Contents/Resources/logs"
